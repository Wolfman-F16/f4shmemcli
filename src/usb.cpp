 ...
 */
usb_dev_handle* openUsbDevice(uint16_t pVendorId, uint16_t pProductId, std::string pProductName) {
	int result;
 ...
 */
int sendData(usb_dev_handle *pDevice, uint8_t pRequest, uint16_t pValue[2]) {
	int32_t r;
	char buffer[16];
 ...
 */
int sendLargeData(usb_dev_handle *pDevice, uint8_t pRequest, char *pBuffer) {
	int32_t r;
